...
function setup() {
  ...
  pugImage = loadImage("assets/pug.png");
...
function draw() {
  ...
  rotate(radians(alpha)); // rotate the pug depending on the alpha intake

  image(pugImage, 0, 0, 500, 500);
  // rect(0, 0, 100, 100) ;
  pop();
  ...
  fill('black');
  stroke('white');
  text("ORIENTATION:", 25, 25);
  textSize(15);
  text("ALPHA: " + alpha, 25, 50);
  text("BETA: " + beta, 25, 70);
  text("GAMMA: " + gamma, 25, 90);
  textSize(20);
  text("ACCELERATION:", 25, 125);
  textSize(15);
